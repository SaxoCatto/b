...
def compare_test_run(trr: TestRunResult) -> TestRunResult:
	...
	#print(f"Checkpoint in check_logs: trr.rtl_trace = {trr.rtl_trace}, trr.dir_test = {trr.dir_test}")
        print(f"Checkpoint in check_logs: [FAILED]: Processing the ibex trace failed: {e}\n")
        return trr
